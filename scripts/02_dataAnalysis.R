...
# create directories
dir.create(path = "output/modeling_rf/RF_cercozoa")
dir.create(path = "output/modeling_rf/RF_fungi")
dir.create(path = "output/modeling_rf/RF_omnivore")
dir.create(path = "output/modeling_rf/RF_bacterivore")
# the computing time is long. Consider a few hours on a regular machine.
source("scripts/RF_cercozoa.R") # random forest to predict Cercozoa beta diversity
source("scripts/RF_fungi.R") # random forest to predict fungi beta diversity
source("scripts/RF_omnivore.R") # random forest to predict omnivore beta diversity
source("scripts/RF_bacterivore.R") # random forest to predict bacterivore beta diversity
...
table_rf_1 = table_rf[which(table_rf$Name == "Fungi" |  table_rf$Name == "Cercozoa"),]
table_rf_2 = table_rf[which(table_rf$Name == "Omnivore" |  table_rf$Name == "Bacterivore"),]
# plot 1
svg("./output/figure/barplot_RF_fungi_cercozoa.svg", 
...
dev.off()
# plot 2
svg("./output/figure/barplot_RF_omnivore_bacterivore.svg", 
    width=4, height=4, family="sans")
...
svg("output/figure/spls_analysis2.svg", width = 6, height = 6)
spls_final_plot = cim(spls_final, comp = 1:2, xlab = "", ylab = "", margins = c(4, 8), color=colfunc(20), threshold = 0.0)
dev.off()
